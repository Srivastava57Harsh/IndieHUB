      ...
      <div className="absolute inset-0 z-40">
        ...
        <div className="mt-[10vh] ml-[45vw] justify-center absolute">
          ...
          >
            ...
            <span class="absolute top-0  left-0 w-[28.5vh] h-48 -mt-1 transition-all duration-500 ease-in-out rotate-[30deg] -translate-x-56 -translate-y-24 bg-[#FC4754] opacity-100 group-hover:-translate-x-8"></span>
